...
This is a personal portfolio/resume website for a student. The project consists of 4 separate HTML pages: <br>
1. Home Page (<i>index.html</i>) - Main landing page with personal information, contact details, education summary, and experience <br>
2. Education Page (<i>results.html</i>) - Displays educational certificates (JSC, SSC, HSC) <br>
3. Skills Page (<i>skill.html</i>) - Showcases technical skills like C, C++, Java, HTML, WordPress, and Data Analysis <br>
